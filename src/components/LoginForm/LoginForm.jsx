  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#c9b3e0] via-[#fbcdd7] to-[#ffe7a1] relative overflow-hidden">
      ...
      <motion.div
        ...
        animate={{ y: [0, -35, 0], x: [0, 15, 0], rotate: [0, 360] }}
          ...
          <AnimatePresence>
            {emailText && (
              <motion.div
                ...
                style={{ left: "1rem", top: "2rem", fontFamily: "'Fredoka One', sans-serif" }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                style={{ fontFamily: "'Fredoka One', sans-serif", caretColor: "#fbcdd7", boxShadow: "3px 3px 0 #8B7BA8" }}
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  {showPassword ? (
                    ...
                    {/* Animated Jar section */}
                    <div className="flex-1 hidden lg:flex items-center justify-center">
                      <AnimatedJar isValid={isValid} isNotValid={isNotValid} reset={reset} />
                    </div>
                  </div>
                </div>
              );
